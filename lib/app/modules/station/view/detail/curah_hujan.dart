...
class CurahHujanCard extends StatelessWidget {
  final StationModel station;

  const CurahHujanCard({super.key, required this.station});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
          'Tinggi Muka Air: ${station.siaga2.toString()} ${station.unitDisplay ?? ''}',
        ),
        trailing: Container(
